...
def HoltropMennenPowerCalculation(length: float, beam: float, T: float, displacementMass: float, v: float,
                                  ...
                                  numBlades: int = 3, n: float = 3, propKeelClearance: float = 0.2, K_Q: float = 0.7, flowAppendage = 1.5, pdRatio: float = 1.0) -> float:
    ...
    :type flowAppendage: float, optional
    :param pdRatio: Pitch-diameter ratio, defaults to 1.0.
    :type pdRatio: float, optional
